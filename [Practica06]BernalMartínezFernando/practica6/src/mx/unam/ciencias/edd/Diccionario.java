...
public class Diccionario<K, V> implements Iterable<V> {
     ...
     * @param dispersa el dispersor a utilizar.
     */
    public Diccionario(Dispersor<K> dispersa) {
        this(MIN_N, dispersa);
    }
     ...
     */
    public Diccionario(int tam, Dispersor<K> dispersa) {
    ...
    private int calculaIndice(K llave) {
        return dispersa.dispersa(llave) & mascara;
    }
